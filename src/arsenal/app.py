...
class SlimScrollBarRender(ScrollBarRender):
    def render_bar(
        ...
        **kwargs
        ...
        # Указываем цвет линии (blue) и ПУСТОЙ фон (None), 
        # чтобы просвечивал фон подлежащего виджета
        style_bar = Style(color="#0000FF", bgcolor=None) 
...
class arsenal(App):
    ...
    CSS = """
        ...
        VerticalScroll, ListView {
            ...
            scrollbar-size: 1 1;
            scrollbar-color: blue 30%;
            scrollbar-color-hover: blue 30%;
        ...
        #input_container Input:focus {
            border: round blue;  /* тонкая округлая рамка при фокусе */
        }
        ...
        /* Фокус: меняем синий фон на рамку blue */
        ...
        #data_buttons_container Button:focus {
            ...
            color: blue;
            text-style: bold;
            border: round blue;  /* При фокусе рамка становится видимой */
            content-align: left middle;
        }
