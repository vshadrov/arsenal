...
class SlimScrollBarRender(ScrollBarRender):
    def render_bar(
        ...
        **kwargs
        ...
        # Указываем цвет линии (#008080) и ПУСТОЙ фон (None), 
...
class Rate2Screen(Screen):
    ...
    BINDINGS = [
        ...
        Binding("f2", "prev_step", "Назад", show=True, priority=True),
        Binding("f3", "next_step", "Вперед", show=True),
        Binding("pageup", "scroll_guide_up", "Листать вверх", show=True),
        Binding("pagedown", "scroll_guide_down", "Листать вниз", show=True, priority=True),
        Binding("f10", "open_draft", "Открыть черновик", show=True),
        Binding("f12", "save_draft", "Сохранить черновик", show=True, priority=True),
    ]
...
class LookScreen(Screen):
    ...
    def show_selected_assessment(self):
        ...
        try:
            ...
            btn_back = Button("В. Назад к поиску          ", variant="default", id=btn_back_id)
...
class DataScreen(Screen):
    ...
    DATA_DESCRIPTIONS = {
        "btn_import": "Эта функция объединяет данные из папки \"Арсенал - данные\", "
                    ...
                    "2. Запустить эту функцию, она объединяет файлы пациентов и базу данных.\n\n"
...
class arsenal(App):
    ...
    CSS = """
        ...
        VerticalScroll, ListView {
            ...
            scrollbar-size: 1 1;
            scrollbar-color: #008080 30%;
            scrollbar-color-hover: #008080 30%;
        ...
        #input_container Input:focus {
            border: round #008080;  /* тонкая округлая рамка при фокусе */
        }
        ...
        /* Фокус: меняем синий фон на рамку #008080 */
        ...
        #data_buttons_container Button:focus {
            ...
            color: #008080;
            text-style: bold;
            border: round #008080;  /* При фокусе рамка становится видимой */
            content-align: left middle;
        }
